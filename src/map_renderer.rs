...
fn get_block_colors() -> FnvHashMap<&'static str, Rgb<u8>> {
    FnvHashMap::from_iter([
        ...
        ("deepslate_coal_ore", Rgb([80, 82, 86])),
        ("deepslate_iron_ore", Rgb([95, 92, 90])),
        ("deepslate_copper_ore", Rgb([90, 92, 88])),
        ("deepslate_gold_ore", Rgb([110, 105, 92])),
        ("deepslate_redstone_ore", Rgb([100, 82, 82])),
        ("deepslate_lapis_ore", Rgb([75, 88, 108])),
        ("deepslate_diamond_ore", Rgb([92, 108, 107])),
        ("deepslate_emerald_ore", Rgb([82, 104, 88])),
